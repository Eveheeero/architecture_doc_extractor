...
fn get_operation_summary(page: &[String]) -> (&[String], String, String) {
     ...
     */
    let regex2_filter = Regex::new("^(T1|TLD|Q/PUNPCKLQDQ|VFMADDSUB231PH|H/VFMSUBADD231PH|VFNMADD231PD|VFNMADD231SD)-").unwrap();
